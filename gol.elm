...
type Board = Dict.Dict (Int,Int) Bool
...
stepCell board pos state board' = let n = uncurry (countNeighbors board) pos in
...
stepClick (mx, my) board = Dict.insert (mx `div` 16, my `div` 16) True board
...
initialBoard : Board
initialBoard = [[False,False,False,False,False,False,False,False,False,False,False,False,False,False,False,False],
...
main : Signal Element
main = displaySim <~ foldp stepSim initialBoard (every second)
